...
namespace Scripts.DevicePortal
{
    internal static class Utilities
    {
        ...
        public static bool IsHoloLens(
            DevicePortalWrapper.DevicePortalPlatforms platform,
            string deviceFamily)
        {
            bool isHoloLens = false;

            if ((platform == DevicePortalWrapper.DevicePortalPlatforms.HoloLens) ||
                ((platform == DevicePortalWrapper.DevicePortalPlatforms.VirtualMachine) && (deviceFamily == "Windows.Holographic")))
            {
                isHoloLens = true;
            }
