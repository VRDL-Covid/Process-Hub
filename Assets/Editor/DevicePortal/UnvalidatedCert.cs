...
namespace Scripts.DevicePortal
{
    ...
    public delegate bool UnvalidatedCertEventHandler(DevicePortalWrapper sender, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors);
}
