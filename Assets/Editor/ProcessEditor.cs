       ...
       //     //DevicePortalWrapper.PutFile(conInfo, "LocalAppData", "textUpLoad.txt")
        ...
        void CheckFinalise()
        {
            ...
            if (GUILayout.Button("Finalize and Close"))
            {
                ...
                jsonPath = EditorUtility.SaveFilePanel("Create or Select a json file to save", Application.persistentDataPath,$"AnchorData_{System.DateTime.Now.ToString("MMMM_dd_yy_h_mm")}", "json");
