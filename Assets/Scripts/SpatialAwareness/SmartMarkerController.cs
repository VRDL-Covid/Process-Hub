...
namespace Scripts.SpatialAwareness
{
    public class SmartMarkerController : MonoBehaviour
    {
        ...
        [Tooltip("Set to confirm that smart marker has 3 correct axis (set by code)")]
        public bool isValidConfiguration = false;
        [Tooltip("Set when all axes are tracking the spatial mesh (set by code)")]
        public bool isReady = false;
        [Tooltip("Set when all axes are within their angle tolerance (set by code)")]
        public bool isInAngleTolerance = false;

        [Header("State Machine Control")]
        [Tooltip("Set by the user to initiate the state machine")]
        ...
        public Vector3 parentDestination = Vector3.zero;
        ...
        void Start()
        {
            ...
            //messages.text = "Adjust the Marker and click \"Toggle Smart Marker\" when in position";
