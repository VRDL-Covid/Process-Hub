...
namespace WebRequestHandlerProxy
{
    ...
    public class HttpHeadersHelper
    {
        ...
        internal void RetrieveCsrfToken(HttpResponseMessage response)
        {
        ...
        public static T ReadJsonStream<T>(System.IO.Stream dataStream, DataContractJsonSerializerSettings settings = null)
        {
            T data = default(T);
